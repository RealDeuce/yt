...
yt_player_decode(struct yt_player *player, const struct yt_record *record)
{
	...
	player->team = (int)yt_record_get_number(record, YT_F89);
	player->danger_scanner = (int)yt_record_get_number(record, YT_F93);
