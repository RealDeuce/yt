...
enum yt_basic_fault_site {
	...
	YT_BASIC_FAULT_ACTION_FINALIZER_PLAYER_INDEX_CINT,
	YT_BASIC_FAULT_RADIO_OPEN,
	YT_BASIC_FAULT_RADIO_LOF,
	...
	YT_BASIC_FAULT_RADIO_OPENING_OUTPUT,
	YT_BASIC_FAULT_RADIO_LOG_HEADING_OUTPUT,
	YT_BASIC_FAULT_RADIO_AUTO_HEADING_OUTPUT,
	YT_BASIC_FAULT_RADIO_PAUSE_OUTPUT,
	YT_BASIC_FAULT_RADIO_PRIVATE_WAIT,
	YT_BASIC_FAULT_SITE_COUNT,
};

#define YT_BASIC_FAULT_ERRORS 16U
...
bool yt_main_error_append_fatal_to(const char *path,
    const struct yt_main_error_result *result, struct yt_error *error);
bool yt_main_error_append_fatal(const struct yt_main_error_result *result,
